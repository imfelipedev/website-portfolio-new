...
export default function Home() {
    return (
        <>
            <section id="home" className="w-full min-h-[100dvh] flex items-center justify-center relative">
                <div className="max-w-[70.0rem] flex flex-col items-center justify-center">
                    ...
                    <p className="mt-10 text-[3.6rem] font-semibold">Felipe Augusto</p>

                    <p className="mt-5 text-center text-[1.6rem] text-[#a1a1a1]">
            ...
            <section id="about" className="py-[8.0rem] w-full border-t-[0.1rem] border-white/10 flex items-center justify-center">
                <div className="max-w-[90.0rem] w-full space-y-[5.0rem]">
                    <div>
                        <p className="text-[3.0rem] text-[#fafafa] font-semibold">Sobre</p>

                        <p className="text-[1.8rem] text-[#a1a1a1]">
                    ...
                    <div className="w-full">
                        <p className="text-[2.4rem] text-[#fafafa] font-semibold">Habilidades</p>
                    ...
                    <div>
                        <p className="text-[2.4rem] text-[#fafafa] font-semibold">Interesses</p>

                        <p className="mt-5 text-[1.6rem] text-[#a1a1a1]">
            ...
            <section id="experience" className="py-[8.0rem] w-full border-t-[0.1rem] border-white/10 flex items-center justify-center">
                <div className="max-w-[70%] w-full">
                    <p className="text-center text-[3.6rem] text-[#fafafa] font-semibold">Experiências</p>

                    <p className="mt-5 text-center text-[1.8rem] text-[#a1a1a1]">Minha jornada e evolução como desenvolvedor.</p>

                    <div className="mt-20 space-y-20 relative">
                        <div className="absolute left-1/2 top-32 bottom-20 w-1 bg-white/10 -translate-x-1/2"></div>
                        ...
                        {TIMELINE.map((item, index) => {
                            return (
                                <div key={`timeline-${index}`} className="w-full relative">
                                    ...
                                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-14 h-14 rounded-full border-12 border-white bg-black"></div>
                                </div>
                            );
                        })}
                    </div>
            ...
            <section id="project" className="py-[8.0rem] w-full border-t-[0.1rem] border-white/10 flex items-center justify-center">
                <div className="max-w-[70.0rem] w-full">
                    <p className="text-[3.6rem] text-[#fafafa] font-semibold">Projetos</p>
            ...
            <section id="contact" className="py-[8.0rem] w-full border-t-[0.1rem] border-white/10 flex items-center justify-center">
                <div className="max-w-[50.0rem] flex flex-col items-center justify-center gap-8">
                    <p className="text-[3.6rem] text-[#fafafa] font-semibold">Contatos</p>

                    <p className="text-center text-[1.8rem] text-[#a1a1a1]">Sinta-se à vontade para entrar em contato para colaborações ou apenas para um amigável olá.</p>
